...
const useStorage = (file) => {
    ...
    useEffect(() => {
    // tham chiếu đến firebase storage và firebase firestore(database)
...
// giải thích code từ nguyên file này (https://chat.openai.com/?model=text-davinci-002-render-sha)